...
def initiateFile(filehandler):
	...
	filehandler.write('<key id="ProductPropertyNumeric_6" for="node" attr.name="ProductPropertyNumeric_6" attr.type="int"/>\n')
	...
	filehandler.write('<key id="ProductPropertyTextual_6" for="node" attr.name="ProductPropertyTextual_6" attr.type="string"/>\n')
	...
	filehandler.write('<key id="rating_6" for="node" attr.name="Rating_6" attr.type="int"/>\n')
	filehandler.write('<key id="productID" for="node" attr.name="productID" attr.type="int"/>\n')
	filehandler.write('<key id="productTypeID" for="node" attr.name="productTypeID" attr.type="int"/>\n')
	filehandler.write('<key id="reviewerID" for="node" attr.name="reviewerID" attr.type="int"/>\n')
	filehandler.write('<key id="reviewID" for="node" attr.name="reviewID" attr.type="int"/>\n')
...
def foo(filename, graphMLFileName, logger):
	...
	logger.info("Started Reading all the Reviewer nodes and writing it to the file")
	...
	logger.info("Finished Reading Reviewer Tags. Total Edges created in the graph till now = %d" % len(allEdges))
